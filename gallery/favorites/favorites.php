<?php
    ...
    $items = getUserFavoriteItems($_SESSION[SESSION_USERID], 30, $page, !isset($_GET["unavailable"]));
        ...
        <main class="container mt-4">
            ...
            <ul class="pagination justify-content-center">
                <li class="page-item <?php if($items->pagination->page == 0){ ?>disabled<?php } ?>">
                    <a class="page-link" href="/gallery/favorites/0">
                        <span>&lArr;</span>
                    </a>
                </li>

                <li class="page-item <?php if($items->pagination->page == 0){ ?>disabled<?php } ?>">
                    <a class="page-link" href="/gallery/favorites/<?php print($items->pagination->page - 1); ?>">
                        <span>&laquo;</span>
                    </a>
                </li>
                ...
                <?php for($page_pos = $previous_pages; $page_pos <= $next_pages; $page_pos++){ ?>
                    <li class="page-item <?php if($page_pos == $items->pagination->page){ ?>active<?php } ?>">
                        <a class="page-link" href="/gallery/favorites/<?php print($page_pos); ?>">
                ...
                <li class="page-item <?php if($items->pagination->page == $items->pagination->max_page){ ?>disabled<?php } ?>">
                    <a class="page-link" href="/gallery/favorites/<?php print($items->pagination->max_page); ?>">
                        <span>&rArr;</span>
                    </a>
                </li>
            </ul>
